...
<body class="w100">
    <header>
        <div class="container">
          <span>指不定报啥错呢,艺术就是爆炸！</span>
	            <div id="regBlock" style="display:none;float:right">
	               <a href="login.jsp" ><img src="${pageContext.request.contextPath}/img/we.png">进入后台</a>
            ...
            <a class="color_e4"><img src="${pageContext.request.contextPath}/img/phone.png" draggable="false"> 天天报错&#x3000;&#x3000;没脸贴电话</a>
        ...
        <div class="container">
            ...
            <div class="course-info">
                <table cellspacing="10">
                    <tr>
                        <td colspan="2">
                            <a href=<c:url value='/web/toList.do?SubjectId=1' />>
                        ...
                        <td>
                            <!--上线时修改id-->
                            <a href="<c:url value='/web/toList.do?SubjectId=2' />">
                        ...
                        <td rowspan="2" class="one_three">
                            <a href="<c:url value='/web/toList.do' />" class="opacity5">
        ...
        <div class="mask_content">
            ...
            <div class="mask_content_body">
                <form id="loginForm" action="#">
                    ...
                    <div id="forget">
                        <a href="<c:url value='/user/login.do' />">忘记密码？</a>
                    </div>
    ...
    <div class="mask hidden" id="reg">
        <div class="mask_content">
            ...
            <div class="mask_content_body">
                <form id="regForm" action="user/insertUser.do">
                    <h3>新用户注册</h3>
