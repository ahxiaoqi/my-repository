...
<body>
	...
	<div class="container">
		...
		<form class="form-horizontal" action="<c:url value='/video/update.do'/>" method="post" enctype="multipart/form-data">
			<div class="form-group">
				<input type="hidden" name="id" value="${video.id }">
				<label for="videoTitle" class="col-sm-2 control-label">视频标题</label>
				<div class="col-sm-10">
					<input type="text" class="form-control" name="title"
						id="videoTitle" placeholder="视频标题" value="${video.title }">
				</div>
			</div>
				...
				<div class="col-sm-10" style="width:300px">
					<select name="courseId" class="form-control">
						...
						<c:forEach items="${courses }" var="course">
							<option value="${course.id }" ${course.id==video.courseId?'selected':'' }>${course.courseTitle }</option>
						</c:forEach>
					</select>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" name="playNum"
						id="playTime" placeholder="视频时长" value="${video.time }">
				</div>
			</div>
			<div class="form-group" >
				...
				<div class="col-sm-10" >
					...
					<img alt="暂时还没有" class="img-rounded" style="width:30%;margin:10px 0" src="/upload/images/${video.imageUrl}" >
			...
			<div class="form-group">
				...
				<div class="col-sm-10" style="width:500px">
					...
					<video style="width:60%" src="/upload/video/${video.videoUrl}" poster="/upload/video/${video.videoUrl}" controls="controls"></video>
